...
export function VideoWidget({ files = [], activeFileId = null, selectedFileId = null, onBrowseFiles, onOpenPreview }: VideoWidgetProps) {
  ...
  const sourceItems = useMemo(
    ...
    [onOpenPreview, selectedFile, selectedSource, setVideoState, videoFiles, videoState.sources],
  );
