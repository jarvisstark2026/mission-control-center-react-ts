...
- NSIS installer ran successfully and created:
  - Installed executable: `%LOCALAPPDATA%\Mission Control\mission-control-center.exe`
  - Start Menu shortcut: `%APPDATA%\Microsoft\Windows\Start Menu\Programs\Mission Control.lnk`
